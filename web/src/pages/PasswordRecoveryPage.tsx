  ...
  const handleResetSubmit = async (data: ResetPasswordFormData) => {
    ...
    try {
      ...
      toast.error("Failed to reset password", {
        description:
          error.response?.data?.message || "Token may be invalid or expired.",
              ...
              <Tooltip>
                ...
                <TooltipContent>
                  <p className="max-w-xs">
                    All reset links expire after 24 hours and can only be used
                    once. Your password is never stored in plain text.
                  </p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
