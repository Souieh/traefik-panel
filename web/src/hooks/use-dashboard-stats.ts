    ...
    const fetchStats = async () => {
      try {
        ...
        setStats({
          ...
          config: {
            services: configResponses[0].data.length,
            routers: configResponses[1].data.length,
            middlewares: configResponses[2].data.length,
            tcpRouters: configResponses[3].data.length,
            tcpServices: configResponses[4].data.length,
            udpRouters: configResponses[5].data.length,
            udpServices: configResponses[6].data.length,
          },
          real: {
